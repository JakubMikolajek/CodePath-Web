...
const buttonVariants = cva(
  "inline-flex shrink-0 items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold tracking-[-0.01em] transition-all duration-200 disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-45 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 [&_svg]:shrink-0 outline-none focus-visible:ring-[3px] focus-visible:ring-ring/45 focus-visible:ring-offset-0 aria-invalid:ring-destructive/30 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default:
          "border border-primary/50 bg-[linear-gradient(135deg,oklch(0.64_0.24_258),oklch(0.62_0.25_288))] text-primary-foreground shadow-[0_0_26px_oklch(0.62_0.24_270/0.32)] hover:brightness-110 hover:shadow-[0_0_38px_oklch(0.62_0.24_270/0.45)] active:scale-[0.99]",
        glow:
          "border border-primary/50 bg-[linear-gradient(135deg,oklch(0.64_0.24_258),oklch(0.62_0.25_288))] text-primary-foreground shadow-[0_0_32px_oklch(0.62_0.24_270/0.42)] hover:translate-y-[-1px] hover:brightness-110",
        destructive:
        ...
        nav:
          "justify-start rounded-xl px-3 text-muted-foreground hover:bg-sidebar-accent/70 hover:text-foreground data-[active=true]:border data-[active=true]:border-primary/45 data-[active=true]:bg-[linear-gradient(135deg,oklch(0.58_0.22_258/0.92),oklch(0.45_0.2_285/0.72))] data-[active=true]:text-white data-[active=true]:shadow-[0_0_26px_oklch(0.62_0.24_270/0.3)]",
